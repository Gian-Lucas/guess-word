...
Esse é um jogo de adivinhação de palavras, baseado no [term.ooo](https://term.ooo/). Com esse projeto, foram praticados diversos conceitos do ReactJS, como:
* Estados (State)
* Contextos (Context API)
* Estilização com Sass + CSS Modules
...
> Deploy da aplicação em <https://gword.vercel.app>

![Imagem do app](/images/image.png)
...
```
git clone https://github.com/Gian-Lucas/guess-word.git
```
